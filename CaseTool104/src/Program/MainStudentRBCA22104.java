...
public class MainStudentRBCA22104 {
	
	    public static void main(String[] args) {
	        // Creating instances of Student class
	    	StudentRBCA22104  student1 = new StudentRBCA22104 ();
	    	StudentRBCA22104  student2 = new StudentRBCA22104 ();
	    	StudentRBCA22104  student3 = new StudentRBCA22104 ();
